...
public class Payment extends JFrame {
	...
	add(FlightDetails);
            ...
            ticket_id.setBounds(60, 240, 150, 27);
            add(ticket_id);
            
            textField_4 = new JTextField();
            textField_4.setBounds(200, 240, 150, 27);
            add(textField_4);


            JLabel jny_date = new JLabel("JOURNEY DATE");
            jny_date.setFont(new Font("Tahoma", Font.PLAIN, 17));
            jny_date.setBounds(60, 280, 150, 27);
            add(jny_date);
            ...
            jny_time.setBounds(60, 320, 150, 27);
            add(jny_time);
            ...
            src.setBounds(60, 360, 150, 27);
            add(src);
            
            textField_7 = new JTextField();
            textField_7.setBounds(200, 360, 150, 27);
            add(textField_7);


            JLabel dst = new JLabel("DESTINATION");
            dst.setFont(new Font("Tahoma", Font.PLAIN, 17));
            dst.setBounds(60, 400, 150, 27);
            add(dst);
            
            textField_8 = new JTextField();
            textField_8.setBounds(200, 400, 150, 27);
            add(textField_8);

            JLabel seat_id = new JLabel("SEAT ID");
            seat_id.setFont(new Font("Tahoma", Font.PLAIN, 17));
            seat_id.setBounds(440, 150, 150, 27);
            add(seat_id);
            
            textField_9 = new JTextField();
            textField_9.setBounds(580, 150, 150, 27);
            add(textField_9);

// adding button
            JButton Next = new JButton("SEARCH FOR INFO");
            Next.setBounds(440, 80, 150, 30);
...
//Again text and text field
            ...
            card_no.setBounds(440, 220, 150, 27);
            add(card_no);
            
            textField_10 = new JTextField();
            textField_10.setBounds(580, 220, 150, 27);
            add(textField_10);

//padi amo
            JLabel paid_amt = new JLabel("PAID AMOUNT");
            paid_amt.setFont(new Font("Tahoma", Font.PLAIN, 17));
            paid_amt.setBounds(440, 270, 150, 27);
            add(paid_amt);
            
            textField_11 = new JTextField();
            textField_11.setBounds(580, 270, 150, 27);
            add(textField_11);
//paydate
            JLabel pay_date = new JLabel("PAY DATE");
            pay_date.setFont(new Font("Tahoma", Font.PLAIN, 17));
            pay_date.setBounds(440, 320, 150, 27);
            add(pay_date);
            
            textField_12 = new JTextField();
            textField_12.setBounds(580, 320, 150, 27);
            add(textField_12);
...
// action listeners
 ...
 Next_2.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        conn c = new conn();
                        String str = "INSERT INTO reservation values( '"+pnr_no+"', '"+name+"', '"+phone+"','"+ticket_id+"', '"+f_code+"', '"+jny_date+"','"+jny_time+"', '"+src+"','"+dst+"','"+seat_id+"')";
                        String str2 = "INSERT INTO payment values( '"+pnr_no+"', '"+name+"', '"+phone+"','"+card_no+"', '"+f_code+"', '"+paid_amt+"','"+pay_date+"')";
